...
**Follow-up flagged (not W1):** `geographyBackfill.test.js` is red on `main` (production-DB snapshot fixture drifted to 9 gcj02 stops vs the asserted 7). Worth a separate fixture-refresh task.
