...
| Offline | Installed-PWA start, route navigation, and deep-link refresh work after a completed precache. | ✅ Local: all 10 route chunks cached post-activation. **Installed-PWA airplane-mode cold start = owner post-deploy check** |
