...
**Status:** IN PROGRESS — Wave 1 CLOSED (committed `450c493`, deployed `a2e93f0`, owner prod QA passed 2026-07-21 via the click-script). Wave 2 implemented 2026-07-21, not yet deployed. Waves 3–4 not started.
