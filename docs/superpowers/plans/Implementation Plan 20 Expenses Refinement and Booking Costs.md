...
**Status:** IN PROGRESS — Wave 1 CLOSED (committed `450c493`, deployed `a2e93f0`, owner prod QA passed 2026-07-21 via the click-script). Wave 2 implemented + deployed 2026-07-21 (`6e71a1b`), owner prod QA pending. Waves 3–4 not started.
